    ...
    <View className="gap-3">
      <View className="gap-1">
        ...
        <Text className={`text-base leading-6 ${TEXT_ON_GRADIENT_BODY}`}>
          A calm guide to wallet basics, key concepts, and safe habits on Solana Mobile.
        </Text>
      </View>
      <View className={`gap-2 rounded-2xl p-4 ${SURFACE_CARD}`}>
        ...
        <Text className={`text-xs leading-5 ${TEXT_ON_SURFACE_MUTED}`}>
          Work through each section at your own pace. Wallet steps need a real connection; learning steps
          are self-checks.
        </Text>
      </View>
    </View>
